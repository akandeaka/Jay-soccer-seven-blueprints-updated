...
class FilterConfig:
    ...
    TELEGRAM_BOT_TOKEN = "8634288532:AAEGeI0DaqNIklrx8jWrLnW7dzhc41_wrS4"  # REPLACE WITH YOUR ACTUAL TOKEN
    TELEGRAM_CHAT_ID = "401821398"     # REPLACE WITH YOUR ACTUAL CHAT ID
